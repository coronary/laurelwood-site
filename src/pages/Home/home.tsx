	...
	return (
		<section className="mainContent">
			...
			<p className="bulk-text text-2xl lg:text-4xl font-bold pt-2 pb-4">	This year we're celebrating our 25th anniversary and we couldn't have done it without our faithful customers and hard-working staff. Although we no longer have pubs for you to visit and try our award-winning beers we encourage you to pick up a 6 pack of Workhorse IPA, Free Range Red, or one of our 16oz rotating seasonal beers. <a className="homeLink">See what's available here</a>, and <a className="homeLink">where to get it here</a>. We'll also have a special 25th anniversary beer available in mid-March. We're bringing back the first beer we ever canned!
				...
				<br />
				<br />
				Stay with us this year. <a className="homeLink">Sign up for our newsletter</a>, follow us on all our socials to keep up with what we have happening this year.
				<br />
				<br />
				Cheers!
			</p>
